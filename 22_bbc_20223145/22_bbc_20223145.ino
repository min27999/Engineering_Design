...
// Servo adjustment
#define _DUTY_MAX 2400  // Servo angle: D degree
#define _DUTY_NEU 1475  // Servo angle: 0 degree
#define _DUTY_MIN 550   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 1369 + -8.04 * a_value + 0.0165 * a_value * a_value + -1.14E-05 * a_value * a_value * a_value;
}
